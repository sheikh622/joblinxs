...
import { addAdminCategory, deleteCategory, getCategoryList, updateCategory, getSingleList, addSubAdminCategory } from "../../Redux/Category/actions";
        ...
        {loader ? (
          ...
          <>
            <Row className="py-2 justify-content-between align-items-baseline">
              ...
              <Col lg={4} md={5} className="justify-content-end d-flex">
                        ...
                        <Card border="light" className="shadow-sm introCard">
                          ...
                          <div className="detailSection">
                            <span className="left">
                              <h3>{value.title}</h3>
                              <p>{value.details}</p>
                              <h5 className="text-bold cursorPointer" style={{ color: "blue" }} onClick={() => {
                                history.push({ pathname: Routes.SubCategories.path, state: value.id });
                                handleSingleList(value.id);
                              }}>view sub-catogories
                              </h5>
                            </span>
