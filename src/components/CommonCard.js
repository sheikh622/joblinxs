      ...
      <Card border="light" className="shadow-sm selfCard">
        <div className="imgaSection">
          ...
          <span className="starSpan" style={{ cursor: "pointer" }}>
            ...
            {props?.star == 0 ? props?.star : props?.star.toFixed(1)}
          </span>
        ...
        <div className="detailSection">
          <span className="left card-details">
            ...
            <Link className="fw-bold" to={`/detailJob/${props.id}`}>
              <h4>{props.type}</h4>
              {props.paymentType === "hourly" ? <p>
                Hourly Rate: <span>${props.rate}</span>{" "}
              </p> :
                <p>
                  Fixed Rate: <span>${props.rate}</span>{" "}
                </p>
              }
