  ...
  return (
    <Card border="light" className="text-center p-0 mb-4 profileView">
      ...
      <Card.Body className="pb-5">
        ...
        <Card.Text className="text-gray mb-2">(7 Reviews)</Card.Text>
        <Card.Title>Neil Sims</Card.Title>
        <Card.Subtitle className="fw-normal">
          Senior Software Engineer
        </Card.Subtitle>
        <Card.Text className="text-gray mb-2">New York, USA</Card.Text>
        <Card.Text className="text-gray mb-0"> <b>Email:</b> user@xyz.com</Card.Text>
        <Card.Text className="text-gray mb-0"> <b>Phone No. :</b>  123456789</Card.Text>
        <Card.Text className="text-gray mb-0"><b>Work Status:</b>  Full-time</Card.Text>
        <Card.Text className="text-gray mb-0"><b>Can Drive:</b> Yes</Card.Text>
        <Card.Text className="text-gray mb-0"><b>Have Tools :</b> Yes</Card.Text>
      </Card.Body>
    </Card>
  );
};
